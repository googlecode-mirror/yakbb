...
$i[] = "INSERT INTO `".DBPRE."groups` (`id`, `name`, `color`, `replytolocked`) VALUES
...
$d[] = "DROP TABLE IF EXISTS `".DBPRE."messages_threads`";
$c[] = "CREATE TABLE `".DBPRE."messages_threads` (
`id` int(10) unsigned NOT NULL auto_increment,
`title` text NOT NULL,
...
$d[] = "DROP TABLE IF EXISTS `".DBPRE."moderators_relations`";
$c[] = "CREATE TABLE `".DBPRE."moderators_relations` (
`id` int(10) unsigned NOT NULL auto_increment,
