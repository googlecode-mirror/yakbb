...
class template {
	...
	private $errors = array(); // Holds errors generated by template::error()
	...
	public function display(){
		...
		// We don't load this if there's any errors since it won't be used.
		if(file_exists(LIBDIR."template_calls/".$yak->curPage.".calls.php") && count($this->errors) == 0){
